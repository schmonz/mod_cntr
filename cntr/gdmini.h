...
/*
 * $Id: gdmini.h,v 2.1 1998/10/06 08:31:09 dankogai Exp $
 *
 * Written by Tom Boutell, 5/94.
 * Modified by Dan Kogai, Oct-98
 * based upon libgd.c that comes with GD.pm
 *
...
typedef struct {
    ...
    int h;
    /*
     * Font data; array of characters, one row after another. Easily included
     * in code, also easily loaded from data files.
     */
    char *data;
}      gdFont;
